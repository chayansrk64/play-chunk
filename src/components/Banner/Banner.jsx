        ...
        <div className='flex flex-col justify-center items-center p-3 lg:p-0'>
            <div className='text-center mt-3 lg:mt-10'>
                ...
                <div className='flex justify-center items-center gap-6 mb-3 lg:mb-10'>
                    <Link to="https://play.google.com/store/apps" className='flex items-center gap-3 btn font-bold '> <img src={play} alt="" /> Google Play</Link>
                    <Link to="https://www.apple.com/app-store/" className='flex items-center gap-3 btn font-bold'> <img src={app} alt="" /> App Store</Link>
                </div>
            </div>
            <div>
